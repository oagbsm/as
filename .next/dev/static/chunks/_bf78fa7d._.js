...
function AdminProductsPage() {
    ...
    const loadProductDetails = async (product)=>{
        ...
        const { data: variants, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("product_variants").select("id,label,price,mrp,stock").eq("product_id", product.id).order("id");
        if (error) {
            console.error(error);
            setVariantRows([]);
            setStatus({
    ...
    const handleSave = async (e)=>{
        ...
        try {
            ...
            if (cleanVariants.length > 0) {
                ...
                const { error: varError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("product_variants").upsert(payload);
                if (varError) {
