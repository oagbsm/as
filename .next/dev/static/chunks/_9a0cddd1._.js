...
function CartPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartPage.useEffect": ()=>{
            const ids = Array.from(new Set(cartItems.map({
                "CartPage.useEffect.ids": (x)=>x.productId
            }["CartPage.useEffect.ids"])));
            if (!ids.length) {
                setProducts([]);
                setProductVariants([]);
                setProductImages([]);
            ...
            ({
                "CartPage.useEffect": async ()=>{
                    const prods = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchProductsByIds"])(ids);
    ...
    function getVariantImageUrl(productId, variantId) {
        ...
        if (variantId != null) {
            ...
            if (img) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeImg"])(img);
        }
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeImg"])(primary || anyImg || "/example.png");
    }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartPage.useEffect": ()=>{
            ...
            const t = setTimeout({
                "CartPage.useEffect.t": ()=>{
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["searchCustomers"])(q).then({
                        "CartPage.useEffect.t": (rows)=>setSuggestions(rows)
                    }["CartPage.useEffect.t"]).catch({
                        "CartPage.useEffect.t": ()=>setSuggestions([])
                    }["CartPage.useEffect.t"]);
                }
            }["CartPage.useEffect.t"], 150);
            return ({
                "CartPage.useEffect": ()=>clearTimeout(t)
            })["CartPage.useEffect"];
        }
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                        src: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["safeImg"])(img),
                                                        alt: name ?? "Product",
                                                        width: 120,
                                                        height: 120,
...
_s(CartPage, "jQkj9b166exVaqnP0HwZZbfVFQM=", false, function() {
    return [
...
//# sourceMappingURL=_9a0cddd1._.js.map