...
function TopNavBar() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TopNavBar.useEffect": ()=>{
            ...
            const cookieLang = document.cookie.split("; ").find({
                "TopNavBar.useEffect": (row)=>row.startsWith("lang=")
            }["TopNavBar.useEffect"])?.split("=")[1];
...
_s(TopNavBar, "DBnJ2KcIag0bQJ5yPNqmHFJU93k=", false, function() {
    return [
...
//# sourceMappingURL=_05058979._.js.map