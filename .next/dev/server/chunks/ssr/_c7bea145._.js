...
function AddProductPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            // Insert product
            const { data: product, error: productError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("products").insert({
                name,
                slug,
