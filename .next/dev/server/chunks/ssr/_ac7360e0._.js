...
function CheckoutPage() {
    ...
    const [name, setName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("Test Customer");
    ...
    const [address, setAddress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("MATO, MOGADISHU");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        (async ()=>{
            ...
            const vids = cartItems.map((x)=>x.variantId).filter((v)=>v != null);
            try {
    ...
    async function getOrCreateCustomerId(phoneRaw, nameRaw) {
        ...
        const found = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("customers").select("id").eq("phone", phoneClean).maybeSingle();
        if (found.error) throw found.error;
        if (found.data?.id) return Number(found.data.id);
        // 2) Create customer
        const created = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("customers").insert({
            name: nameClean,
            phone: phoneClean
        }).select("id").single();
    ...
    async function placeOrder() {
        ...
        try {
            ...
            const order = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createOrder"])({
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createOrderItems"])(order.id, orderItemsPayload);
            // 2.5) If NOT credit, record payment and mark order as PAID
            if (!isCredit) {
                const paymentInsert = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("payments").insert({
                    order_id: order.id,
                ...
                const upd = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("orders").update({
                    status: "PAID"
                }).eq("id", order.id);
            ...
            try {
                if (productIds.length >= 2) {
                    // Try int[] first
                    let { data: rpcData, error: rpcErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc("record_copurchase", {
                    ...
                    if (rpcErr && rpcErr?.code === "22P02") {
                        ...
                        if (maybeUuids.length >= 2) {
                            const retry = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc("record_copurchase", {
...
//# sourceMappingURL=_ac7360e0._.js.map