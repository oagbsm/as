...
"[project]/data/store.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/store.ts [app-route] (ecmascript)");
;
;
...
async function POST(req) {
    ...
    const rows = items.map((ci)=>{
        const p = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["products"].find((x)=>x.id === ci.productId);
        if (!p) return null;
        const v = ci.variantId != null ? __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$store$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["productVariants"].find((vv)=>vv.id === ci.variantId) : null;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5cef50eb._.js.map